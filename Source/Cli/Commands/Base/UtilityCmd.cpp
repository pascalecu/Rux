...
#include "Rux/Cli/CliInternals.h" // for RegistryPackagesDir, RequireManifest, LoadManifest
...
#include <filesystem>    // for path, directory_entry, directory_iterator, operator/
